        ...
        <div className='relative z-10 mx-auto flex min-h-0 w-full flex-1 flex-col gap-3 overflow-y-auto xl:overflow-hidden'>
          <div className='flex shrink-0 flex-wrap items-center justify-between gap-3'>
            <div className='flex min-w-0 flex-wrap items-center gap-3'>
              <span className='inline-flex shrink-0 items-center gap-1.5 rounded-full border border-cyan-400/20 bg-cyan-500/10 px-2.5 py-1 text-[10px] font-medium tracking-[0.2em] text-cyan-200 uppercase'>
                ...
                <CardHeader className='flex shrink-0 flex-row items-center justify-between px-4 pt-3.5 pb-2'>
                  <div>
                    ...
                    <CardDescription className='mt-0.5 text-xs text-slate-400'>
                      {t('根据最近')}{' '}
                      {rangeOptions.find((item) => item.key === selectedRange)
                        ?.label ?? t('30 天')}
                      {t('的学习节奏')}
                    </CardDescription>
                  </div>
      ...
      >
        <DialogContent className='border-slate-800 bg-slate-950 text-slate-50 sm:max-w-xl'>
          {selectedRecord && (
            <>
              <DialogHeader>
                <div className='inline-flex w-fit items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-2.5 py-1 text-[10px] font-medium tracking-[0.2em] text-cyan-200 uppercase'>
              ...
              <div className='mt-4 space-y-4'>
                <div className='grid gap-3 sm:grid-cols-2'>
                  <div className='rounded-2xl border border-slate-800 bg-slate-900/80 p-4'>
                    <p className='text-sm text-slate-400'>{t('学习评分')}</p>
                    <p className='mt-2 text-3xl font-bold text-white'>
                      {selectedRecord.score}
                    </p>
                  </div>
                  <div className='rounded-2xl border border-slate-800 bg-slate-900/80 p-4'>
                    <p className='text-sm text-slate-400'>{t('状态')}</p>
